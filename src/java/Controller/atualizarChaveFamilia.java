 ...
 * @author yuricampos
 */
public class atualizarChaveFamilia extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(atualizarChaveFamilia.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(atualizarChaveFamilia.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
