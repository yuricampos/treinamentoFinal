 ...
 * @author yuricampos
 */
public class ListarStatusPaciente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            p.setId(pacienteId);
            s.setPaciente(p);
            StatusDAO d =  new StatusDAO();
            List top = (List) d.listar(s);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ListarStatusPaciente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
